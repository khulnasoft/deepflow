...
type ChRegion struct {
	UpdaterBase[mysqlmodel.ChRegion, IDKey]
...
func (r *ChRegion) generateNewData() (map[IDKey]mysqlmodel.ChRegion, bool) {
	log.Infof("generate data for %s", r.resourceTypeName, r.db.LogPrefixORGID)
